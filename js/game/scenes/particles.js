define(['system/entity/scene', 'game/entity/back', 'system/entity/particles', 'system/geo/vector2', 'system/definition/random', 'system/entity/layout', 'system/entity/button', 'system/core/graphic'],
		function(Scene, BackButton, Particles, Vector2, Radnom, Layout, Button, graphic) {
			...
			function ParticleScene() {
				...
				var p2 = new Particles(new Vector2(200, 400), {
					angle: 0,
					interval: 5000,
					rate: 50,
					speed: 400,
				...
				var layout = new Layout.horizontal(new Vector2(0, 500), 0, 40);
				layout.add(BackButton('menu'));
				layout.add(Button.create(new Vector2(0, 0), function() { p1.play() }).rect(80, 80).text("P1"));
				layout.add(Button.create(new Vector2(0, 0), function() { p2.play() }).rect(80, 80).text("P2"));
				this.center(layout);
			}
